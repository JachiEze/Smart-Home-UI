    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(BedroomActivity.this, MainActivity.class);
        ...
        switches[3].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b) {
                    Toast.makeText(getBaseContext(), "Television On", Toast.LENGTH_SHORT).show();
                    textViews[0].setText((++active).toString());
                    textViews[1].setText((--inactive).toString());
                    kilowatthr += 20;
                    textViews[2].setText(kilowatthr.toString() + "kWh");
                    ...
                    Toast.makeText(getBaseContext(), "Television Off", Toast.LENGTH_SHORT).show();
                    textViews[0].setText((--active).toString());
                    textViews[1].setText((++inactive).toString());
                }
            }
