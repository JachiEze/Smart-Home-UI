...
public class WashingRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_washing_room);
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(WashingRoomActivity.this, MainActivity.class);
        ...
        switches[0].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b) {
                    Toast.makeText(getBaseContext(), "Washer On", Toast.LENGTH_SHORT).show();
                    textViews[0].setText((++active).toString());
                    textViews[1].setText((--inactive).toString());
                    kilowatthr += 50;
                    textViews[2].setText(kilowatthr.toString() + "kWh");
                    ...
                    Toast.makeText(getBaseContext(), "Washer Off", Toast.LENGTH_SHORT).show();
                    textViews[0].setText((--active).toString());
                    textViews[1].setText((++inactive).toString());
                }
            }
        ...
        switches[1].setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b) {
                    Toast.makeText(getBaseContext(), "Dryer On", Toast.LENGTH_SHORT).show();
                    textViews[0].setText((++active).toString());
                    textViews[1].setText((--inactive).toString());
                    kilowatthr += 50;
                    textViews[2].setText(kilowatthr.toString() + "kWh");
                    ...
                    Toast.makeText(getBaseContext(), "Dryer Off", Toast.LENGTH_SHORT).show();
                    textViews[0].setText((--active).toString());
                    textViews[1].setText((++inactive).toString());
                }
            }
